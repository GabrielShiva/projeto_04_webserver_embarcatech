...
static err_t tcp_server_recv(void *arg, struct tcp_pcb *tpcb, struct pbuf *p, err_t err)
{
    ...
    snprintf(html, sizeof(html), // Formatar uma string e armazená-la em um buffer de caracteres
             ...
             "<html>\n"
             "<head>\n"
             "<title> Embarcatech - Medidor de Resistência </title>\n"
             "<style>\n"
             ...
             "</head>\n"
             "<body>\n"
             "<h1>Embarcatech: DEFINIÇÃO DA QUANTIDADE DE FAIXAS</h1>\n"
             "<form action=\"./blue_on\"><button>Resistor de 4 faixas</button></form>\n"
             "<form action=\"./blue_off\"><button>Resistor de 5 faixas</button></form>\n"
             "<p class=\"temperature\">Valor Medido: %.2f &deg;C</p>\n"
             "<p class=\"temperature\">Valor Comercial: %.2f &deg;C</p>\n"
             "</body>\n"
             "</html>\n",
             temperature);
